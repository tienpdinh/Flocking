...
class Camera
{
  Camera()
  {
    position      = new PVector( 468.41827, -596.63226, 702.8455 ); // initial position
    theta         = 0.61517054; // rotation around Y axis. Starts with forward direction as ( 0, 0, -1 )
    phi           = -0.65192884; // rotation around X axis. Starts with up direction as ( 0, 1, 0 )
    moveSpeed     = 150;
